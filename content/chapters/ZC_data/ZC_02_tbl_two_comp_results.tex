...
\begin{sidewaystable}
	...
	standard} &
	$E_\mathrm{model}$ & 
	\color{Gray}$2.1 \pm 0.3\%$ & \color{Gray}$5.2 \pm 1.2\%$ & \color{Gray}$6.9 \pm 1.2\%$ & \color{Gray}$8.3 \pm 1.6\%$ & \color{Gray}$2.7 \pm 0.5\%$ & \color{Gray}$4.0 \pm 0.4\%$ & \color{Gray}$9.3 \pm 1.4\%$ & \color{Gray}$19.2 \pm 2.2\%$
	\\
	& & 
	$E_\mathrm{net}$ &
	\cellcolor{White!88!SteelBlue}$5.0 \pm 0.3\%$ & \cellcolor{White!57!SteelBlue}$7.7 \pm 1.5\%$ & \cellcolor{White!50!SteelBlue}$9.7 \pm 2.0\%$ & \cellcolor{White!44!SteelBlue}$10.4 \pm 1.7\%$ & \cellcolor{White!82!SteelBlue}$6.3 \pm 0.6\%$ & \cellcolor{White!88!SteelBlue}$6.9 \pm 0.6\%$ & \cellcolor{White!69!SteelBlue}$8.8 \pm 1.7\%$ & \cellcolor{White!32!SteelBlue}$20.0 \pm 2.2\%$
	\\\cmidrule(l){2-11}
	&
	\multirow{2}{1.7cm}{\raggedleft %0
	standard\textsuperscript{\dag}} &
	$E_\mathrm{model}$ & 
	\color{Gray}$2.0 \pm 0.3\%$ & \color{Gray}$3.2 \pm 0.4\%$ & \color{Gray}$5.7 \pm 0.7\%$ & \color{Gray}$5.0 \pm 1.1\%$ & \color{Gray}$2.8 \pm 0.6\%$ & \color{Gray}$3.2 \pm 0.5\%$ & \color{Gray}$9.0 \pm 1.7\%$ & \color{Gray}$13.7 \pm 1.5\%$
	\\
	& & 
	$E_\mathrm{net}$ &
	\cellcolor{White!94!SteelBlue}$4.7 \pm 0.3\%$ & \cellcolor{White!88!SteelBlue}$5.4 \pm 0.6\%$ & \cellcolor{White!69!SteelBlue}$7.7 \pm 1.0\%$ & \cellcolor{White!88!SteelBlue}$7.2 \pm 1.2\%$ & \cellcolor{White!88!SteelBlue}$6.1 \pm 0.6\%$ & \cellcolor{White!94!SteelBlue}$6.0 \pm 0.6\%$ & \cellcolor{White!75!SteelBlue}$8.3 \pm 1.8\%$ & \cellcolor{White!75!SteelBlue}$14.9 \pm 1.8\%$
	\\\cmidrule(l){2-11}
	&
	\multirow{2}{1.7cm}{\raggedleft %1
	noise model} &
	...
	& & 
	$E_\mathrm{net}$ &
	\cellcolor{White!32!SteelBlue}$9.8 \pm 1.1\%$ & \cellcolor{White!50!SteelBlue}$7.9 \pm 1.0\%$ & \cellcolor{White!82!SteelBlue}$7.2 \pm 1.3\%$ & \cellcolor{White!38!SteelBlue}$11.1 \pm 1.2\%$ & \cellcolor{White!7!SteelBlue}$15.0 \pm 2.2\%$ & \cellcolor{White!32!SteelBlue}$12.0 \pm 1.2\%$ & \cellcolor{White!50!SteelBlue}$11.3 \pm 1.2\%$ & \cellcolor{White!44!SteelBlue}$18.8 \pm 2.0\%$
	\\\cmidrule(l){2-11}
	&
	\multirow{2}{1.7cm}{\raggedleft %1
	noise model\textsuperscript{\dag}} &
	...
	& & 
	$E_\mathrm{net}$ &
	\cellcolor{White!7!SteelBlue}$11.2 \pm 0.9\%$ & \cellcolor{White!69!SteelBlue}$6.9 \pm 0.4\%$ & \cellcolor{White!75!SteelBlue}$7.6 \pm 0.6\%$ & \cellcolor{White!69!SteelBlue}$8.8 \pm 1.0\%$ & \cellcolor{White!25!SteelBlue}$14.8 \pm 1.8\%$ & \cellcolor{White!19!SteelBlue}$12.1 \pm 0.9\%$ & \cellcolor{White!82!SteelBlue}$8.1 \pm 1.0\%$ & \cellcolor{White!69!SteelBlue}$16.3 \pm 0.9\%$
	\\\midrule
	...
	standard} &
	$E_\mathrm{model}$ & 
	\color{Gray}$1.8 \pm 0.3\%$ & \color{Gray}$5.7 \pm 1.2\%$ & \color{Gray}$7.0 \pm 1.2\%$ & \color{Gray}$9.5 \pm 1.9\%$ & \color{Gray}$2.7 \pm 0.6\%$ & \color{Gray}$3.8 \pm 0.4\%$ & \color{Gray}$10.1 \pm 1.3\%$ & \color{Gray}$19.8 \pm 2.3\%$
	\\
	& & 
	$E_\mathrm{net}$ &
	\cellcolor{White!57!SteelBlue}$6.8 \pm 0.5\%$ & \cellcolor{White!25!SteelBlue}$9.6 \pm 1.7\%$ & \cellcolor{White!32!SteelBlue}$11.5 \pm 2.8\%$ & \cellcolor{White!25!SteelBlue}$12.8 \pm 2.0\%$ & \cellcolor{White!69!SteelBlue}$8.2 \pm 0.8\%$ & \cellcolor{White!69!SteelBlue}$8.2 \pm 0.8\%$ & \cellcolor{White!38!SteelBlue}$11.6 \pm 2.5\%$ & \cellcolor{White!25!SteelBlue}$21.8 \pm 2.6\%$
	\\\cmidrule(l){2-11}
	&
	\multirow{2}{1.7cm}{\raggedleft %0
	standard\textsuperscript{\dag}} &
	$E_\mathrm{model}$ & 
	\color{Gray}$1.8 \pm 0.3\%$ & \color{Gray}$3.6 \pm 0.5\%$ & \color{Gray}$5.9 \pm 0.7\%$ & \color{Gray}$5.7 \pm 1.2\%$ & \color{Gray}$2.7 \pm 0.6\%$ & \color{Gray}$3.1 \pm 0.4\%$ & \color{Gray}$9.5 \pm 1.9\%$ & \color{Gray}$14.0 \pm 1.7\%$
	\\
	& & 
	$E_\mathrm{net}$ &
	\cellcolor{White!63!SteelBlue}$6.5 \pm 0.4\%$ & \cellcolor{White!63!SteelBlue}$7.3 \pm 0.8\%$ & \cellcolor{White!38!SteelBlue}$10.5 \pm 1.8\%$ & \cellcolor{White!57!SteelBlue}$9.6 \pm 1.4\%$ & \cellcolor{White!75!SteelBlue}$8.0 \pm 0.7\%$ & \cellcolor{White!82!SteelBlue}$7.3 \pm 0.7\%$ & \cellcolor{White!32!SteelBlue}$12.2 \pm 3.1\%$ & \cellcolor{White!57!SteelBlue}$18.2 \pm 2.2\%$
	\\\cmidrule(l){2-11}
	&
	\multirow{2}{1.7cm}{\raggedleft %1
	noise model} &
