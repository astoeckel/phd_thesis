...
\begin{sidewaystable}
	\caption[Complete results for the two-compartment LIF benchmark experiment with pre-filter]{Complete results for the two-compartment LIF benchmark experiment with pre-filter. \textsuperscript{\dag}With subthreshold relaxation.}
