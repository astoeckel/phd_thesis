...
With some patience, this problem, including nonnegativity constraints for \vrap and \mrAp, can be converted into a quadratic program with sparse $\mat P$ and $\mat G$ (cf.~\Cref{dec:qp}).%
\footnote{
